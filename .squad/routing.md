...
| Code review | Rusty | Review PRs, check quality, enforce contracts and conventions |
| Architecture / contracts | Rusty | Cross-package types, shared module, build order, design trade-offs |
