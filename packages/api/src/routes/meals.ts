...
// Create meal
mealsRouter.post('/:familyId/meals', authenticateJWT, requireMembership, async (req: Request, res: Response) => {
  try {
...
// Get meal detail
mealsRouter.get('/:familyId/meals/:mealId', authenticateJWT, requireMembership, async (req: Request, res: Response) => {
  try {
    const familyId = paramStr(req.params.familyId);
...
// Update meal
mealsRouter.put('/:familyId/meals/:mealId', authenticateJWT, requireMembership, async (req: Request, res: Response) => {
  try {
...
mealsRouter.delete('/:familyId/meals/:mealId', authenticateJWT, requireMembership, requireRole('PARENT'), async (req: Request, res: Response) => {
  try {
    const familyId = paramStr(req.params.familyId);
    const mealId = paramStr(req.params.mealId);
